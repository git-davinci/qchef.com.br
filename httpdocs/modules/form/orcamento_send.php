...
function body() {
	...
	<table width="450" border="0" cellpadding="2" cellspacing="0">
		<tr>
			<td colspan="2" class="texto">'.@$_POST['nome'].' solicitou um orçamento com a Qchef</td>
		</tr>
		<tr>
			<td class="texto">&nbsp;</td>
			<td class="texto">&nbsp;</td>
		...
		<tr>
			<td class="texto">Tipo de envio:</td>
			<td class="texto">'.@$_POST['tipo'].'</td>
		</tr>
		<tr>
			<td class="texto">Quantidade de pessoas estimada:</td>
			<td class="texto">'.@$_POST['quantidade'].'</td>
		</tr>
		<tr>
			<td class="texto">Data do evento:</td>
			<td class="texto">'.@$_POST['data'].'</td>
		</tr>
		<tr>
			<td class="texto">Hora:</td>
			<td class="texto">'.@$_POST['hora'].'</td>
		</tr>
		<tr>
